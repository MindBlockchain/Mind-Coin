...
#ifndef MINDBLOCKCHAIN_WALLET_WALLET_H
#define MINDBLOCKCHAIN_WALLET_WALLET_H
...
public:
     ...
     * on this mindblockchain node, and set to 0 for transactions that were created
...
#endif // MINDBLOCKCHAIN_WALLET_WALLET_H
