...
#ifndef MINDBLOCKCHAIN_WALLET_WALLETUTIL_H
#define MINDBLOCKCHAIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! mindblockchain from opening the wallet, thinking it was newly created, and
...
#endif // MINDBLOCKCHAIN_WALLET_WALLETUTIL_H
