...
#ifndef MINDBLOCKCHAIN_UTIL_MESSAGE_H
#define MINDBLOCKCHAIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's mindblockchain address, it must refer to a public key.
...
#endif // MINDBLOCKCHAIN_UTIL_MESSAGE_H
