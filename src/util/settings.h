...
#ifndef MINDBLOCKCHAIN_UTIL_SETTINGS_H
#define MINDBLOCKCHAIN_UTIL_SETTINGS_H
...
//!       https://github.com/mindblockchain/mindblockchain/pull/15934/files#r337691812)
...
#endif // MINDBLOCKCHAIN_UTIL_SETTINGS_H
