...
#ifndef MINDBLOCKCHAIN_UTIL_REF_H
#define MINDBLOCKCHAIN_UTIL_REF_H
 ...
 * (https://github.com/mindblockchain/mindblockchain/issues/16684)
 */
class Ref
{
public:
...
#endif // MINDBLOCKCHAIN_UTIL_REF_H
