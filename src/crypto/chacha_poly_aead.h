...
#ifndef MINDBLOCKCHAIN_CRYPTO_CHACHA_POLY_AEAD_H
#define MINDBLOCKCHAIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@mindblockchain.
 *
 ...
 *
 * The chacha20-poly1305@mindblockchain combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@mindblockchain cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@mindblockchain are relatively fast in
...
#endif // MINDBLOCKCHAIN_CRYPTO_CHACHA_POLY_AEAD_H
