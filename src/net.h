...
#ifndef MINDBLOCKCHAIN_NET_H
#define MINDBLOCKCHAIN_NET_H
...
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on MindBlockchain’s Peer-to-Peer Network")
