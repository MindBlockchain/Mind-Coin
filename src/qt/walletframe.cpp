...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, MindBlockchainGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &MindBlockchainGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &MindBlockchainGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &MindBlockchainGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &MindBlockchainGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &MindBlockchainGUI::updateWalletStatus);
    connect(gui, &MindBlockchainGUI::setPrivacy, walletView, &WalletView::setPrivacy);
