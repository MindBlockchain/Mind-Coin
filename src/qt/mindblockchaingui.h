...
#ifndef MINDBLOCKCHAIN_QT_MINDBLOCKCHAINGUI_H
#define MINDBLOCKCHAIN_QT_MINDBLOCKCHAINGUI_H
...
/**
  MindBlockchain GUI main class. This class represents the main window of the MindBlockchain UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MindBlockchainGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MindBlockchainGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~MindBlockchainGUI();
...
public Q_SLOTS:
    ...
    /** Load Partially Signed MindBlockchain Transaction from file or clipboard */
...
#endif // MINDBLOCKCHAIN_QT_MINDBLOCKCHAINGUI_H
