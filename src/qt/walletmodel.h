...
#ifndef MINDBLOCKCHAIN_QT_WALLETMODEL_H
#define MINDBLOCKCHAIN_QT_WALLETMODEL_H
...
/** Interface to MindBlockchain wallet from Qt view code. */
...
#endif // MINDBLOCKCHAIN_QT_WALLETMODEL_H
