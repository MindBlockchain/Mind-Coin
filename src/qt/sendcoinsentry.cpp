    ...
    platformStyle(_platformStyle)
{
    ...
    // normal mindblockchain address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying mindblockchain address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &MindBlockchainAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
