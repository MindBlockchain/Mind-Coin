...
//! Entry point for MindBlockchainApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &MindBlockchainApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for MindBlockchainGUI tests.
void AppTests::guiTests(MindBlockchainGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &MindBlockchainGUI::consoleShown, this, &AppTests::consoleTests);
