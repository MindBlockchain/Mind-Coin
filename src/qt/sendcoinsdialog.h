...
#ifndef MINDBLOCKCHAIN_QT_SENDCOINSDIALOG_H
#define MINDBLOCKCHAIN_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending mindblockchains */
...
#endif // MINDBLOCKCHAIN_QT_SENDCOINSDIALOG_H
