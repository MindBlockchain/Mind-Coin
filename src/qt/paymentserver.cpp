...
const QString BITCOIN_IPC_PREFIX("mindblockchain:");
#ifdef ENABLE_BIP70
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/mindblockchain-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/mindblockchain-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/mindblockchain-paymentrequest";
#endif
