 ...
 */
static const char* BITCOIN_PID_FILENAME = "mindblockchaind.pid";
...
void Shutdown(InitInterfaces& interfaces)
{
    ...
    RenameThread("mindblockchain-shutoff");
...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://mindblockchain.io>";
...
static void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("mindblockchain-loadblk");
