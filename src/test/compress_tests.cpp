...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1MIND 10000

// amounts 50 .. 21000000
#define NUM_MULTIPLES_50MIND 420000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    BOOST_CHECK(TestPair(913200000 * COIN, 0x1406f40));
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_1MIND; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64_t i = 1; i <= NUM_MULTIPLES_50MIND; i++)
