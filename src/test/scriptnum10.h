...
#ifndef MINDBLOCKCHAIN_TEST_SCRIPTNUM10_H
#define MINDBLOCKCHAIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from MindBlockchain Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // MINDBLOCKCHAIN_TEST_BIGNUM_H
