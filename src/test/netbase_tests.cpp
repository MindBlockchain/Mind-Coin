...
{
    BOOST_CHECK(TestSplitHost("www.mindblockchaincore.org", "www.mindblockchaincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.mindblockchaincore.org]", "www.mindblockchaincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.mindblockchaincore.org:80", "www.mindblockchaincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.mindblockchaincore.org]:80", "www.mindblockchaincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:46032", "127.0.0.1", 46032));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:46032", "127.0.0.1", 46032));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:46032", "::ffff:127.0.0.1", 46032));
    BOOST_CHECK(TestSplitHost("[::]:46032", "::", 46032));
    BOOST_CHECK(TestSplitHost("::46032", "::46032", -1));
    BOOST_CHECK(TestSplitHost(":46032", "", 46032));
    BOOST_CHECK(TestSplitHost("[]:46032", "", 46032));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:46032", "127.0.0.1:46032"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:46032", "[::]:46032"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
