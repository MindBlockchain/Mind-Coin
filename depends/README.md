...
**MindBlockchain Core's configure script by default will ignore the depends output.** In
...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_mindblockchain` executable (see https://github.com/mindblockchain/mindblockchain/pull/13543),
