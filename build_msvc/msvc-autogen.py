...
libs = [
    'libmindblockchain_cli',
    'libmindblockchain_common',
    'libmindblockchain_crypto',
    'libmindblockchain_server',
    'libmindblockchain_util',
    'libmindblockchain_wallet_tool',
    'libmindblockchain_wallet',
    'libmindblockchain_zmq',
    'bench_mindblockchain',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='MindBlockchain-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/mindblockchain_config.h'), os.path.join(SOURCE_DIR, 'config/mindblockchain-config.h'))
