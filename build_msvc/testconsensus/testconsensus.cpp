...
// mindblockchain includes.
#include <..\src\script\mindblockchainconsensus.h>
...
int main()
{
    std::cout << "mindblockchainconsensus version: " << mindblockchainconsensus_version() << std::endl;
    ...
    auto op0Result = mindblockchainconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, mindblockchainconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
