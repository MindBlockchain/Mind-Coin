...
// mind includes.
#include <..\src\script\mindconsensus.h>
...
int main()
{
    std::cout << "mindconsensus version: " << mindconsensus_version() << std::endl;
    ...
    mindconsensus_error err;
    auto op0Result = mindconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, mindconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
