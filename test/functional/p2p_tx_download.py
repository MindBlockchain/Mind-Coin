...
class TxDownloadTest(MindBlockchainTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new mindblockchaind instances, as setting mocktimes has long-term effects on when
