...
# TestP2PConn: A peer we use to send messages to mindblockchaind, and store responses.
...
class CompactBlocksTest(MindBlockchainTestFramework):
    ...
    # This test actually causes mindblockchaind to (reasonably!) disconnect us, so do this last.
    ...
    # mindblockchaind's choice of nonce.
    ...
    # Test that mindblockchaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for mindblockchaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # mindblockchaind will not send blocktxn responses for blocks whose height is
