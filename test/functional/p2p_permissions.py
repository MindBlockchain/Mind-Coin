...
class P2PPermissionsTests(MindBlockchainTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].mindblockchainconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].mindblockchainconf, 'w', encoding="utf8") as f:
            f.write(newText)
