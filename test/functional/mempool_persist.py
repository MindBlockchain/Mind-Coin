...
By default, mindblockchaind will dump mempool on shutdown and
...
class MempoolPersistTest(MindBlockchainTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent mindblockchaind from writing mempool.dat to disk. Verify that `savemempool` fails")
