...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MindBlockchainTestFramework
    pass


class ExampleTest(MindBlockchainTestFramework):
    # Each functional test is a subclass of the MindBlockchainTestFramework class.
    ...
    def custom_method(self):
        ...
        MindBlockchainTestFramework class so other tests can use it."""
