...
class TestShell:
    """Wrapper Class for MindBlockchainTestFramework.

    The TestShell class extends the MindBlockchainTestFramework
    ...
    class __TestShell(MindBlockchainTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by MindBlockchainTestFramework child class.
            self.num_nodes = 1
