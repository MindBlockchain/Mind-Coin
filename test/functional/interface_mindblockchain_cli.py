...
# The block reward of coinbaseoutput.nValue (50) MIND/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 MIND/block.
BLOCKS = 101
...
class TestMindBlockchainCli(MindBlockchainTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `mindblockchain-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and mindblockchain-cli getwalletinfo return expected wallet info")
            ...
            # Mine a block to confirm; adds a block reward (50 MIND) to the default wallet.
            ...
            # Test mindblockchain-cli -generate.
            n1 = 3
            n2 = 4
            ...
            # Test mindblockchain-cli -generate with -rpcwallet in multiwallet mode.
