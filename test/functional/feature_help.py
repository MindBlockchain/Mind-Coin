...
"""Verify that starting mindblockchain with -h works as expected."""

from test_framework.test_framework import MindBlockchainTestFramework
from test_framework.util import assert_equal

class HelpTest(MindBlockchainTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mindblockchain with -h for help text")
        ...
        self.log.info("Start mindblockchain with -version for version information")
        ...
        self.log.info("Start mindblockchaind with -fakearg to make sure it does not start")
