...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/MindBlockchain
else
  DOCKER_EXEC echo \> \$HOME/.mindblockchain
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/mindblockchain/mindblockchain/pull/18288#discussion_r433189350 for
  # details.
