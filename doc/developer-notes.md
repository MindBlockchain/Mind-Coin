...
([`valgrind.supp`](https://github.com/mindblockchain-project/mindblockchain/blob/master/contrib/valgrind.supp))
...
- ThreadSocketHandler : Sends/Receives data from peers on port 7808.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 7807 for connections and services them.
