Contributing to MindBlockchain Core
============================

The MindBlockchain Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "MindBlockchain Core
...
Before you start contributing, familiarize yourself with the MindBlockchain Core build
system and tests. Refer to the documentation in the repository on how to build
MindBlockchain Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/mindblockchain/mindblockchain/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/mindblockchain/mindblockchain/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[MindBlockchain Core PR Review Club](https://mindblockchaincore.reviews/) meeting.
...
Most communication about MindBlockchain Core development happens on IRC, in the
`#mindblockchain-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/mindblockchain-core-dev/](http://www.erisian.com.au/mindblockchain-core-dev/)
and [http://gnusha.org/mindblockchain-core-dev/](http://gnusha.org/mindblockchain-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/mindblockchain-dev)
...
For GUI-related issues or pull requests, the https://github.com/mindblockchain-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/mindblockchain/mindblockchain node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to mindblockchain-qt
...
fork of MindBlockchain Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/mindblockchain/mindblockchain/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MindBlockchain Core project (and related
projects such as libsecp256k1), and is not to be confused with overall MindBlockchain
Network Protocol consensus changes.

Whether a pull request is merged into MindBlockchain Core rests with the project merge
...
Patches that change MindBlockchain consensus rules are considerably more involved than
...
Where a patch set proposes to change the MindBlockchain consensus, it must have been
...
https://github.com/mindblockchain/mindblockchain/pull/16189).

Also see the [backport.py script](
https://github.com/mindblockchain-core/mindblockchain-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each MindBlockchain Core release.
