...
EXCLUDE = [
    # auto generated:
    'src/qt/mindblockchainstrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The MindBlockchain Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a mindblockchain source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The MindBlockchain Core developers'
...
Arguments:
    <file> - A source file in the mindblockchain repository.
"""
