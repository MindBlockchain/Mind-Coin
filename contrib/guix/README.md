# Bootstrappable MindBlockchain Core Builds

This directory contains the files necessary to perform bootstrappable MindBlockchain
Core builds.
...
- 24GB of free disk space on the partition that the MindBlockchain Core git repository
  resides in
...
For a MindBlockchain Core depends development environment, simply invoke
...
From the top of a clean MindBlockchain Core repository:
...
To use dongcarl's substitute server for MindBlockchain Core builds after having
