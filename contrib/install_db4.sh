...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the mindblockchain repository."
  exit 1
fi
...
# See https://github.com/mindblockchain/mindblockchain/issues/16064
...
echo 'When compiling mindblockchaind, run `./configure` in the following way:'
echo
